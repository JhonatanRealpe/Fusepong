...
CREATE TABLE `detalle_ticket` (
  `iddetalle_ticket` int NOT NULL AUTO_INCREMENT,
  `comentario` varchar(255) DEFAULT NULL,
  `fecha` datetime DEFAULT NULL,
  `idestado` int DEFAULT NULL,
  `idticket` int DEFAULT NULL,
  PRIMARY KEY (`iddetalle_ticket`),
  KEY `FK_DETALLETICKET_ESTADO_idx` (`idestado`),
  KEY `FK_DETALLETICKET_TICKET_idx` (`idticket`),
  CONSTRAINT `FK_DETALLETICKET_ESTADO` FOREIGN KEY (`idestado`) REFERENCES `estado` (`idestado`),
...
-- Dump completed on 2021-03-10 16:21:59
